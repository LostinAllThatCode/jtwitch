...
public class TwitchAPI {
	...
	/**
	 * Permissions defined in justin.tv/twitch.tv api. user_read, // Read access
	 * to non-public user information, such as email address. user_read, // Read
	 * access to non-public user information, such as email address.
	 ...
	 * email address and stream key channel_editor, // Write access to channel
	 * metadata (game, status, etc). channel_commercial, // Access to trigger
	 * commercials on channel. channel_stream, // Ability to reset a channel's
	 * stream key. channel_subscriptions, // Read access to all subscribers to
	 * your channel. user_subscriptions, // Read access to subscriptions of a
	 * user. channel_check_subscription, // Read access to check if a user is
	 * subscribed to your channel. chat_login // Ability to log into chat and
	 * send messages.
	 * 
	 * @author agaida
	 */
	 ...
	 * @throws JsonSyntaxException
	 */
	public boolean hasPermisson(Permission... p) throws	TwitchAPIUnauthorizedAccessException, IOException {
	 ...
	 * @throws JsonSyntaxException
	 */
	private List<String> getPermissions() throws TwitchAPIUnauthorizedAccessException, IOException {
